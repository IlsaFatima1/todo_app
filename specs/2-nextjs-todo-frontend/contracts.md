# API Contracts: Next.js Todo Application Frontend
...
This document defines the API contracts for the Next.js Todo Application Frontend, specifying the expected backend API endpoints and the frontend components' interfaces.
...
- **Error Response**: 400 Bad Request, 401 Unauthorized, 404 Not Found, 500 Internal Server Error
